...
# Root folder
root = 'C:/Users/kemba/OneDrive/Desktop/Publication/project/datasets/end2end_match_gt/depth_images'
...
img, label = data[6]
print('The depth image has a shape of', img.shape)
...
class DDenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        # Key changes: first Conv2D in_channels = 1
...
load_model = DDenseNet()
model_path = 'C:/Users/kemba/OneDrive/Desktop/Publication/project/weight_d_model.pt'
